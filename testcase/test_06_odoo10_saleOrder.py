...
class Test_odoo10_saleOrder_page(unittest.TestCase):
    ...
    def setUp(self):
        ...
        globals()['url_new_pickingout'] = ConfigUtils("testdata").get_values_by_key("odoo10", "url_new_pickingout")
    ...
    @unittest.skip("had tested")
    def test_02_saleOrder_Approval(self):
    ...
    # @unittest.skip("had tested")
    def test_05_Pickingout_Approval(self):
        globals()['lp'].login("jingjing.liu@aqara.com", "123456")
        sop = odoo10_SaleOrder_Page_Business(self.driver)
        sop.Pickingout_Approval(globals()['url_new_pickingout'])
